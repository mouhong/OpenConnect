...
{
    public class TaobaoGetUserInfoRequest : IGetUserInfoRequest
    {
        ...
        public TaobaoGetUserInfoRequest(bool useSandBoxMode)
            : this(useSandBoxMode, OpenConnect.Providers.HttpClient.Instance)
        {
        }
