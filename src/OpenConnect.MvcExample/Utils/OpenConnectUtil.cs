    ...
    public class OpenConnectUtil
    {
        ...
        static OpenConnectUtil()
        {
            ...
            manager.Add("QQ", new QQOpenConnectClient(
                new AppInfo("100238506", "0379c7b5e5f78aa7909f2238d3186893", null)));

            manager.Add("Tencent Weibo", new TencentWeiboOpenConnectClient(
                new AppInfo("801176853", "a8d4c7256c54b2a5be5c414d42ac5d70", "all")));

            manager.Add("Sina Weibo", new SinaWeiboOpenConnectClient(
                new AppInfo("2841977476", "f8abbb8426b825822f81ef80bb648d08", null)));

            manager.Add("Renren", new RenrenOpenConnectClient(
                new AppInfo("d932b70a58d84905a66aa6b06e47377b", "30f63d25cff548649a51f73c952299b7", null)));

            manager.Add("Live", new LiveOpenConnectClient(
                new AppInfo("0000000040080F13", "yIs33isum4ZmnahwPbyGNbnJY4RoiyvS", "wl.signin,wl.basic")));

            manager.Add("Google", new GoogleOpenConnectClient(
                new AppInfo("352501794367.apps.googleusercontent.com", "lQ8ShnALbvYfM0lbQ0vUzLCv", "https://www.googleapis.com/auth/userinfo.profile")));

            manager.Add("Taobao", new TaobaoOpenConnectClient(
                new AppInfo("12412746", "0a5fc2c8beef294900e1fcf7bda46af2", null)));
